    ...
    <div className="toolbar" ref={toolbarRef}>
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="16"
          height="16"
          fill="currentcolor"
          className="bi bi-arrow-counterclockwise format" viewBox="0 0 512 512">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="16"
          height="16"
          fill="currentcolor"
          className="bi bi-arrow-clockwise format" viewBox="0 0 512 512">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="16"
          height="16"
          fill="black"
          className="bi bi-type-bold format" viewBox="0 0 384 512">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="16"
          height="16"
          fill="black"
          className="bi bi-type-italic format" viewBox="0 0 320 512">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="16"
          height="16"
          fill="black"
          className="bi bi-type-underline format" viewBox="0 0 448 512">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="16"
          height="16"
          fill="black"
          className="bi bi-type-strikethrough format" viewBox="0 0 512 512">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" className="bi bi-text-left format" viewBox="0 0 448 512">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="16"
          height="16"
          fill="black"
          className="bi bi-text-center format" viewBox="0 0 448 512">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="16"
          height="16"
          fill="black"
          className="bi bi-text-right format" viewBox="0 0 448 512">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="16"
          height="16"
          fill="black"
          className="bi bi-justify format" viewBox="0 0 448 512">
